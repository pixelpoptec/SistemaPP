...
$sql_check = "SELECT id FROM tarefas WHERE 
              id = ? AND 
              usuario_id = ? AND 
...
// Verificar se já existe um rastreamento ativo para este usuário (verificar a necessidade dessa rotina)
...
if ($result->num_rows > 0) {
    ...
    // Finalizar o registro ativo anterior

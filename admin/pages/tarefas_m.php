...
$modo_visualizacao = isset($_GET['modo']) ? sanitizar($_GET['modo']) : (isset($_SESSION['modo_visualizacao']) ? $_SESSION['modo_visualizacao'] : 'cards');
                                    ...
                                    <div class="col-md-6 col-lg-4 mb-4">
                                        <div class="card tarefa-card <?php echo $prioridade_class; ?>">
                                            <div class="card-header d-flex justify-content-between align-items-center">
                                                <h6 class="card-title mb-0"><?php echo $tarefa['id'] . " - " . $tarefa['nome']; ?></h6>
